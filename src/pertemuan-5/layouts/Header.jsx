...
export default function Header() {
    return (
        <div id="header-container" className="flex justify-between items-center p-4">
            ...
            <div id="icons-container" className="flex items-center space-x-4 relative p-3 bg-blue-100 rounded-2xl text-blue-500 cursor-pointer">
                {/* Icons */}
                ...
                <div id="chart-icon" className="p-3 bg-red-100 rounded-2xl text-red-500 cursor-pointer">
                    <FcAreaChart />
                </div>
